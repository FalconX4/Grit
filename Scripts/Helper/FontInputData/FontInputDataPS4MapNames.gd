extends RefCounted
class_name FontInputDataPS4MapNames
# Auto generated class by ControllerFontData

const mapping_button: Dictionary[int, String] = {
	JoypadMapEnum.ButtonMap.A: '',
	JoypadMapEnum.ButtonMap.B: '',
	...
	JoypadMapEnum.ButtonMap.LEFT_SHOULDER: '',
	JoypadMapEnum.ButtonMap.RIGHT_SHOULDER: '',
	JoypadMapEnum.ButtonMap.DPAD_UP: '',
